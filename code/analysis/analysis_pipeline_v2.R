source("~/Documents/consolidated_code_server/code/extra_functions.R")
...
run_analysis_pipeline <- function(data, respondent_col, firm_col, survey_vars, experimental_vars,
                                  ...
                                  output_filename, industry_map_path, process_outcomes = FALSE, 
  ...
  output_path <- file.path(excel_dir, paste0(output_filename, ".xlsx"))
  ...
  if (process_outcomes) {
    set.seed(seed)
    source("~/Documents/consolidated_code_server/code/2a_plackett_luce.R")
    source("~/Documents/consolidated_code_server/code/win_share_v2.R")  # compute_pairwise_strictwins_wide
    source("~/Documents/consolidated_code_server/code/bootstrap_manual.R")
    source("~/Documents/consolidated_code_server/code/bootstrap_pairwise_manual.R")
    source("~/Documents/consolidated_code_server/code/EB_procedure.R")
    ...
    for (outcome in survey_vars) {
      ...
      if (isTRUE(sim_pl_to_borda)) {
        ...
        source("~/Documents/consolidated_code_server/code/expected_borda_score.R")
      ...
      if (exact_pl_to_borda) {
        ...
        source("~/Documents/consolidated_code_server/code/pl_to_borda.R")
        source("~/Documents/consolidated_code_server/code/borda_score.R")
    ...
    # ---------- Experimental sheets ----------
    source("~/Documents/consolidated_code_server/code/2a_experimental.R")
  ...
  if (run_bs_eiv) {
    set.seed(seed)
    source("~/Documents/consolidated_code_server/code/eiv_bootstrap.R")
    source("~/Documents/consolidated_code_server/code/bootstrap_summary.R")
    
    # pairs <- list(
    #   c("dif",                          "FirmCont_favor_white", "EIVBS_dif_cont_white"),
    #   c("dif",                          "conduct_black", "EIVBS_dif_cond_white"),
    #   c("log_dif",                      "FirmCont_favor_white", "EIVBS_logdif_cont_white"),
    #   c("log_dif",                      "conduct_black", "EIVBS_logdif_cond_white"),
    #   c("dif_gender",                   "FirmCont_favor_male", "EIVBS_dif_cont_male"),
    #   c("dif_gender",                   "conduct_favor_male", "EIVBS_dif_cond_male"),
    #   c("log_dif_gender",               "FirmCont_favor_male" , "EIVBS_logdif_cont_male"),
    #   c("log_dif_gender",               "conduct_favor_male" , "EIVBS_logdif_cond_male"),
    #   c("dif_age",                      "conduct_favor_younger" , "EIVBS_dif_cont_young"),
    ...
    # MEA edit: running only centralization
    pairs <- list(
      c("cb_central_full",        "discretion", "EIVBS_central_discretion")
    )
    ...
    remove_sheet_safely(wb, "EIV_BS_central")     # MEA edit: rename temporarily to not write over old results
    addWorksheet(wb, "EIV_BS_central")
    writeData(wb, "EIV_BS_central", eiv_all)
    
    saveWorkbook(wb, output_path, overwrite = TRUE)
    message("✅  Combined EIV / BS Summary saved in sheet “EIV_BS_central")
  }
  ...
  if (pairwise_process) {
    set.seed(seed)
    source("~/Documents/consolidated_code_server/code/1_preprocessing_v3.R")
    source("~/Documents/consolidated_code_server/code/pairwise_process.R")
    source("~/Documents/consolidated_code_server/code/leave_in_connected.R")
  ...
  if (borda_score) {
    set.seed(seed)
    source("~/Documents/consolidated_code_server/code/borda_score.R")
    source("~/Documents/consolidated_code_server/code/EB_procedure.R")   # eb_two_step()
    source("~/Documents/consolidated_code_server/code/borda_bootstrap.R")
    source("~/Documents/consolidated_code_server/code/katz_correct.R")   # var_component_with_var(), katz_correct()
  ...
  if (run_borda_eiv) {
    ...
    # MEA edit: only run for cb_central_full ~ discretion
    pairs <- list(
      c("cb_central_full",        "discretion", "EIVBordaw_central_discretion")
    )
    ...
    remove_sheet_safely(wb, "EIV_Bordaw_central")
    addWorksheet(wb, "EIV_Bordaw_central")
    writeData(wb, "EIV_Bordaw_central", eiv_all)
    
    saveWorkbook(wb, output_path, overwrite = TRUE)
    message("✅  Combined EIV / BS Summary saved in sheet “EIV_Bordaw_central")
  }
  ...
  if (pairwise_process_borda) {
    set.seed(seed)
    source("~/Documents/consolidated_code_server/code/1_preprocessing_v3.R")
    source("~/Documents/consolidated_code_server/code/pairwise_process_borda.R")
    source("~/Documents/consolidated_code_server/code/leave_in_connected.R")
    source("~/Documents/consolidated_code_server/code/borda_score.R")
  ...
  ################################################################################
  # if (run_jackknife) {
  #   source("~/Documents/consolidated_code_server/code/jackknife_manual.R")
  #   source("~/Documents/consolidated_code_server/code/leave_out_connected.R")
  #   source("~/Documents/consolidated_code_server/code/1_preprocessing_v3.R")
  #   for (outcome in survey_vars) {
  ...
  ################################################################################
  # if (run_eiv) {
  #   source("~/Documents/consolidated_code_server/code/eiv_jackknife.R")
  #   source("~/Documents/consolidated_code_server/code/jackknife_summary.R")
  #   
  #   # pairs <- list(
  ...
  # # Run Correlation
  # # -----------------------------------------------
  # source("~/Documents/consolidated_code_server/code/jackknife_correlation.R")
  ...
  # 
  # if (run_bootstrap) {
  #   source("~/Documents/consolidated_code_server/code/2b_bootstrap.R")
  ...
  # }
  # 
  # source("~/Documents/consolidated_code_server/code/2b_bootstrap_se.R")
