...
* Set file paths ;
global localdir "/Users/alemarchetti-bowick/Library/CloudStorage/Dropbox/Audit/Survey" ; 
global rawdir "$localdir/raw_data" ; 
global wrkdir "$localdir/working_data" ; 
...
use "$rawdir/cw_sic87_ind1990ddx/cw_sic87_ind1990ddx.dta", clear ; 
  * collapse to 2-digit ;
  ...
  * resolve duplicates ;
  ...
  merge 1:m ind1990ddx using "$rawdir/cw_ind1990_ind1990ddx/cw_ind1990_ind1990ddx.dta", nogen ;
...
* CPS ; 
#d;
use "$rawdir/morg/cps_00086.dta", clear ;
