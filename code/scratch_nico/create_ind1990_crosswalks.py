# ==============================================================================
# DEPRECATED 2026-04-21: Ported to Stata.
# Active version: code/data_build/create_ind1990_crosswalks.do
# Differences from this Python version:
#   - sic_category column dropped (no 19-category aggregation; CPS aggregation
#     deferred — final output is ind1990 → (sic_87_two_digit, naics3, naics2))
#   - SIC variable renamed to sic_87_two_digit (clearer name)
#   - Output is .dta rather than .csv (Stata-native downstream)
