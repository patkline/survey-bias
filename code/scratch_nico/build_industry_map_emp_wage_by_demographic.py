# ==============================================================================
# DEPRECATED 2026-04-22: Firm-level merge out of scope for current pipeline.
# The downstream firm-level merge step was removed from the data-build metafile
# pending decisions on the final analysis shape. CPS + EEO-1 aggregates are
# now produced independently at the industry × demographic level.
