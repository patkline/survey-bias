# ==============================================================================
# DEPRECATED 2026-04-22: Ported to Stata.
# Active version: code/data_build/build_industry_emp_wage_by_demographic_cps.do
# Differences from this Python version:
#   - Aggregates at 2-digit SIC (sic_87_two_digit) rather than 19-bucket sic_category
#   - Private-sector filter upstream (drops govt workers; matches old Stata + EEO-1 scope)
#   - Hourly workers only — no salaried-branch wage formula
#   - Output is .dta rather than .csv
