...
use "${qje_2022_replication_dump}/covariates_new_cleaning/naics3_race_wage_gap.dta", clear
...
preserve
use "${qje_2022_replication_dump}/covariates_new_cleaning/naics3_gender_wage_gap.dta", clear
...
use "${qje_2022_replication_dump}/covariates_new_cleaning/naics3_shares.dta", clear
...
file open coef_file using "${qje_2022_replication_dump}/figure9_cps_new_cleaning_rebuild_coefficients.csv", write replace
...
foreach touse in white male {
    ...
    * Export CPS-only Figure 9 panel
    ...
    graph export "${qje_2022_replication_figures}/figure9_cps_new_cleaning_`touse'.pdf", replace
}
