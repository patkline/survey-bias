...
use "${qje_2022_replication_dump}/covariates_robustness_variants/naics3_race_wage_gap_`robustness_variant'.dta", clear
...
preserve
use "${qje_2022_replication_dump}/covariates_robustness_variants/naics3_gender_wage_gap_`robustness_variant'.dta", clear
...
use "${qje_2022_replication_dump}/covariates_robustness_variants/naics3_shares_`robustness_variant'.dta", clear
...
foreach touse in white male {
    ...
    * Export CPS-only Figure 9 panel
    ...
    graph export "${qje_2022_replication_figures}/figure9_cps_`robustness_variant'_`touse'.pdf", replace
}
...
compress
save "${qje_2022_replication_dump}/figure9_cps_`robustness_variant'_rebuild_coefficients.dta", replace
