...
* Save comparison rows before loading the college-share allocation-flag robustness coefficients
tempfile comparison_with_no_alloc
save `comparison_with_no_alloc', replace

* Load college-share allocation-flag robustness rebuild coefficients
use "${qje_2022_replication_dump}/figure9_cps_college_share_ignore_allocation_flags_rebuild_coefficients.dta", clear

* Rename college-share allocation-flag robustness coefficients to Stata-safe comparison-table column names
rename coefficient cps_colshare_noalloc_coefficient
rename se cps_colshare_noalloc_se

* Keep the college-share allocation-flag robustness coefficient for each CPS characteristic, panel, and estimate type
keep gap characteristic estimate_type cps_colshare_noalloc_coefficient cps_colshare_noalloc_se
gisid gap characteristic estimate_type
assert _N == 24

* Merge college-share allocation-flag robustness coefficients onto the comparison rows
merge 1:1 gap characteristic estimate_type using `comparison_with_no_alloc'
assert _merge == 3
drop _merge
...
gen double diff_colshare_noalloc_vs_paper = cps_colshare_noalloc_coefficient - paper_coefficient
gen double diff_colshare_noalloc_vs_new = cps_colshare_noalloc_coefficient - cps_new_cleaning_coefficient
...
assert ~mi(diff_colshare_noalloc_vs_paper)
assert ~mi(diff_colshare_noalloc_vs_new)
...
gen double cps_colshare_noalloc_ci_lower = cps_colshare_noalloc_coefficient - 1.96 * cps_colshare_noalloc_se
gen double cps_colshare_noalloc_ci_upper = cps_colshare_noalloc_coefficient + 1.96 * cps_colshare_noalloc_se
...
assert ~mi(cps_colshare_noalloc_ci_lower)
assert ~mi(cps_colshare_noalloc_ci_upper)
...
gen byte colshare_noalloc_reject_zero = cps_colshare_noalloc_ci_lower > 0 | cps_colshare_noalloc_ci_upper < 0
...
assert ~mi(colshare_noalloc_reject_zero)
...
gen byte colshare_noalloc_inside_paper = inrange(cps_colshare_noalloc_coefficient, paper_ci_lower, paper_ci_upper)
...
assert ~mi(colshare_noalloc_inside_paper)
...
order gap characteristic estimate_type paper_coefficient cps_coefficient cps_new_cleaning_coefficient ///
    cps_hourwage_coefficient cps_no_alloc_flags_coefficient cps_colshare_noalloc_coefficient ///
    ...
    diff_colshare_noalloc_vs_paper diff_colshare_noalloc_vs_new ///
    paper_se cps_se cps_new_cleaning_se cps_hourwage_se cps_no_alloc_flags_se cps_colshare_noalloc_se ///
    ...
    cps_colshare_noalloc_ci_lower cps_colshare_noalloc_ci_upper ///
    paper_reject_zero_5pct cps_reject_zero_5pct new_cleaning_reject_zero_5pct ///
    hourwage_reject_zero_5pct no_alloc_flags_reject_zero_5pct colshare_noalloc_reject_zero ///
    cps_inside_paper_ci new_cleaning_inside_paper_ci ///
    hourwage_inside_paper_ci no_alloc_flags_inside_paper_ci colshare_noalloc_inside_paper
...
format paper_coefficient cps_coefficient cps_new_cleaning_coefficient ///
    ...
    cps_hourwage_ci_lower cps_hourwage_ci_upper ///
    cps_no_alloc_flags_ci_lower cps_no_alloc_flags_ci_upper ///
    cps_colshare_noalloc_ci_lower cps_colshare_noalloc_ci_upper %24.17g
